...
const works = [
  {
    id: 1,
    title: "მუხის სასადილო მაგიდა",
    description: "ხელნაკეთი მუხის მასივი, ეპოქსიდური ფისით ჩასხმული. 6 კაცზე გათვლილი.",
    category: "ავეჯი",
    image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&q=80",
    tags: ["მაგიდა", "მუხა", "ეპოქსი"],
  },
  {
    id: 2,
    title: "კაკლის კედლის პანო",
    description: "გეომეტრიული ხეზე კვეთა კაკლის ხეზე, 80×60 სმ.",
    category: "დეკორი",
    image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80",
    tags: ["პანო", "კაკალი", "გეომეტრია"],
  },
  {
    id: 3,
    title: "ნაძვის საბავშვო აკვანი",
    description: "ბუნებრივი ნაძვის ხით, მოჩუქურთმებული ზოლებით.",
    category: "ავეჯი",
    image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&q=80",
    tags: ["აკვანი", "ნაძვი", "ბავშვი"],
  },
  {
    id: 4,
    title: "მუხის კიტხვის სტენდი",
    description: "რეგულირებადი კუთხით, 3 ნაწილად იშლება.",
    category: "სხვა",
    image: "https://images.unsplash.com/photo-1544717305-2782549b5136?w=600&q=80",
    tags: ["სტენდი", "კიტხვა", "მუხა"],
  },
  {
    id: 5,
    title: "კაკლის სასიგარო ყუთი",
    description: "შიდა ველვეტის გადაფენით, სახსრული სახურავით.",
    category: "ყუთი",
    image: "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=600&q=80",
    tags: ["ყუთი", "კაკალი", "ხელოვნება"],
  },
  {
    id: 6,
    title: "ცაცხვის ქანდაკება — მამალი",
    description: "ბუნებრური ფორმის ცაცხვი, სხვადასხვა დამმუშავებლით.",
    category: "ქანდაკება",
    image: "https://images.unsplash.com/photo-1510125594188-5922d935e5e0?w=600&q=80",
    tags: ["ქანდაკება", "ცაცხვი", "ფიგურა"],
  },
  {
    id: 7,
    title: "მუხის სამზარეულოს კომპლექტი",
    description: "ჭამის დაფა, ლარდნიკი, სახელური — მუხის მასივი.",
    category: "სამზარეულო",
    image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80",
    tags: ["სამზარეულო", "დაფა", "მუხა"],
  },
  {
    id: 8,
    title: "კაკლის სასანთლე ტრიო",
    description: "სამი სიმაღლის ბურთული ბაზებით, 9×12×15 სმ.",
    category: "დეკორი",
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80",
    tags: ["სასანთლე", "კაკალი", "სეტი"],
  },
  {
    id: 9,
    title: "ნაძვის სახელოსნო სკამი",
    description: "ძლიერი მესამე ფეხით, სიმყარე 200 კგ-მდე.",
    category: "ავეჯი",
    image: "https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=600&q=80",
    tags: ["სკამი", "ნაძვი", "სახელოსნო"],
  },
];
